...
def setup_logo_map(f):
    ...
    p1 = Polygon(Point(330, 47), Point(306, 108), Point(345, 120), Point(376, 141), \
                 Point(391, 166), Point(391,285), Point(565,285), Point(565,131), \
                 Point(781,131), Point(820,143), Point(853,168), Point(895,238), \
                 Point(962,238), Point(893,31), Point(874,41), Point(857,45), \
                 Point(834,47))
    p1.setFill(etsu_gold)
    p2 = Polygon(Point(339, 327), Point(305, 406), Point(689,406), Point(715,376), \
                 Point(755,346), Point(789,331), Point(795,312), Point(391,312), \
                 Point(391,326))
    p2.setFill(etsu_gold)
    p3 = Polygon(Point(391,431), Point(391,551), Point(379,577), Point(356,597), \
                 Point(334,608), Point(306,615), Point(330,673), Point(820,673), \
                 Point(850,676), Point(875,682), Point(904,693), Point(976,487), \
                 Point(908,487), Point(891,516), Point(870,542), Point(839,567), \
                 Point(816,578), Point(793,585), Point(765,589), Point(565,588), \
                 Point(565,431))
